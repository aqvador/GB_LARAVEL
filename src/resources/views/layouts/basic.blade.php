...
<head>
    ...
    <title>Geekbrains Laravel. Глубокое погружение | {{ $title }}</title>
...
<div
    ...
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
        ...
        <a href="{{ url('/post/view/' . mt_rand(1,1000)) }}" class="text-xssm text-gray-900 underline">1 пост</a> |
        <a href="{{ url('/post/list/10') }}" class="text-xs text-gray-700 underline">10 постов</a> |
        <a href="{{ url('/post/list/50')  }}" class="text-xs text-gray-700 underline">50 постов</a> |
